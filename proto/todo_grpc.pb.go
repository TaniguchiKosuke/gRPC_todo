...
func (c *todoQueryClient) Get(ctx context.Context, in *TodoGetRequest, opts ...grpc.CallOption) (*TodoGetResponse, error) {
	out := new(TodoGetResponse)
	err := c.cc.Invoke(ctx, "/todo.TodoQuery/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTodoQueryServer) Get(context.Context, *TodoGetRequest) (*TodoGetResponse, error) {
...
func _TodoQuery_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.TodoQuery/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoQueryServer).Get(ctx, req.(*TodoGetRequest))
	}
...
func (c *todoCommandClient) Create(ctx context.Context, in *TodoCreateRequest, opts ...grpc.CallOption) (*TodoCreateResponse, error) {
	out := new(TodoCreateResponse)
	err := c.cc.Invoke(ctx, "/todo.TodoCommand/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTodoCommandServer) Create(context.Context, *TodoCreateRequest) (*TodoCreateResponse, error) {
...
func _TodoCommand_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.TodoCommand/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoCommandServer).Create(ctx, req.(*TodoCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
